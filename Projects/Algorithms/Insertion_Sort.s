...
//  Demonstrates insertion sort algorithm with timing and detailed output
...
_start:
    ...
    //  Call test_sort with parameters: size=10, min=2000000000, max=2147483647, seed=x22
    mov     x0, #10
    movz    x1, #0x4A00
    ...
    //  Update seed for next test (if any)
    movz    x0, #0x41C6
    movk    x0, #0x4E6D, lsl #16
    mul     x22, x22, x0
    movz    x0, #0x3039
...
insertion_sort:
    ...
    cmp     x20, #0
    b.le    insertion_sort_done
    cmp     x20, #1000
    b.gt    insertion_sort_done
...
header_msg:
    .asciz  "========================================\n"
    .asciz  "    Insertion Sort Algorithm\n"
    .asciz  "========================================\n\n"
